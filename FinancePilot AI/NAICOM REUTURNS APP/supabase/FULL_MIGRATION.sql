...
-- Return templates (let Postgres auto-generate UUIDs)
...
-- Return definitions (look up template_id via subquery on code)
...
-- Due-date rules (look up definition_id via subquery on code)
...
from (values
  ...
  ('FORM_1C','{"frequency":"AD_HOC","fixed_date":"2026-03-31"}'::jsonb,'2026-01-01',false,'NAICOM circular'),
  ('BROKERAGE_COMMISSION','{"frequency":"ANNUAL","due_month":1,"due_day":31}'::jsonb,'2026-01-01',true,'NAICOM annual returns'),
